...
namespace Utilities.VariableManagement
{
    public static class VariablesManager
    {
        ...
        public static PlayerVariablesScriptableObject playerVariables
        {
            get
            {
                if (_playerVariables == null)
                    _playerVariables = Resources.Load<PlayerVariablesScriptableObject>("Variables/PlayerVariables");
        ...
        public static CameraVariablesScriptableObject cameraVariables
        {
            get
            {
                if (_cameraVariables == null)
                    _cameraVariables = Resources.Load<CameraVariablesScriptableObject>("Variables/CameraVariables");
        ...
        public static UIVariablesScriptableObject uiVariables
        {
            get
            {
                if (_uiVariables == null)
                    _uiVariables = Resources.Load<UIVariablesScriptableObject>("Variables/UIVariables");
        ...
        public static GameplayVariablesScriptableObject gameplayVariables
        {
            get
            {
                if (_gameplayVariables == null)
                    _gameplayVariables = Resources.Load<GameplayVariablesScriptableObject>("Variables/GameplayVariables");
        ...
        public static EnvironmentVariablesScriptableObject environmentVariables
        {
            get
            {
                if (_environmentVariables == null)
                    _environmentVariables = Resources.Load<EnvironmentVariablesScriptableObject>("Variables/EnvironmentVariables");

                return _environmentVariables;
            }
        }

        private static VideoVariablesScriptableObject _videoVariables;
        public static VideoVariablesScriptableObject videoVariables
        {
            get
            {
                if (_videoVariables == null)
                    _videoVariables = Resources.Load<VideoVariablesScriptableObject>("Variables/VideoVariables");

                return _videoVariables;
            }
        }
    }
}